...
//       console.log("addCandidate called with payload:", action.payload);
//       console.log("Current state.candidates:", state.candidates);
      
//       // Safety check in case redux-persist hasn't hydrated yet
...
//       console.log("Candidates after push:", state.candidates.length);
//     },

//     // Update candidate fields (name, email, phone, resumeText)
...
//     // Set final score and summary
//     setCandidateScoreSummary: (state, action) => {
...
//     // Add inside reducers in candidateSlice.js
